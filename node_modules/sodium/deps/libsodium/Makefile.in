...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	AUTHORS ChangeLog THANKS compile config.guess \
	build-aux/config.guess config.sub build-aux/config.sub depcomp \
	install-sh build-aux/install-sh missing build-aux/missing \
